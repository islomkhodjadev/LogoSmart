...
async def hayvonartop(message: types.Message, state: FSMContext):
    ...
    files = [FSInputFile("assets/hayvon_imgs/" + image[1][0])
    ...
    await message.answer_voice(FSInputFile("assets/hayvon_audio/" + sozlar[right_index][1][1], filename=sozlar[right_index][1][1]), reply_markup=buttons)
