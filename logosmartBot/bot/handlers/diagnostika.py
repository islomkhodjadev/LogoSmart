...
async def diagnostika_start(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[0][1]),
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[1][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[2][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[3][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[4][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[5][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[6][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[7][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[8][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
...
async def echo_audio(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(
        FSInputFile("assets/img/" + sozlar[9][1]),
        caption="<blockquote>shu rasmdagi so'zlarni \n"
        "3 martadan takrorlang bitta audioda</blockquote>",
        parse_mode=ParseMode.HTML,
    )
